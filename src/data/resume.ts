...
export const profile: Profile = {
  ...
  summary: [
    "I build software where reliability isn't optional. For the past 14+ years, I've worked across fintech, banking, and enterprise platforms where every release impacts real customers—from mortgage payments and bank transfers to enterprise operations.",
    "My career started in native iOS development, but today I work across the entire stack. I've led mobile platforms, built backend services with Express.js and Spring Boot, designed Azure cloud architectures, and developed distributed systems using Kafka and RabbitMQ. As a founding engineer at a fintech startup, I helped define the mobile, web, and API strategy that launched the company's first products.",
    "I enjoy solving platform-level problems: designing white-label architectures, modernizing authentication for millions of users, building large-scale notification platforms, and more recently, creating AI agent workflows that connect LLMs with enterprise systems to automate complex business decisions.",
